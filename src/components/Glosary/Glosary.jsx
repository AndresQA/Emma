    ...
    return (
        <div className="glosary">
            ...
            <div className="glosary__items">
                <div className="glosary__itemsTitle" onClick={() => handleClick(0)}>
                    <h3>¿Quién es un migrante?</h3>
                    {iconstatus[0] == 0 ? <ExpandMoreIcon style={{ fontSize: 55, color: "#7241A6" }} /> : <ExpandLessIcon style={{ fontSize: 55, color: "#7241A6" }} />}

                </div>
                <div className="glosary__itemsDescription__0">
            ...
            <div className="glosary__items">
                <div className="glosary__itemsTitle" onClick={() => handleClick(1)}>
                    ...
                    <ExpandMoreIcon style={{ fontSize: 55, color: "#7241A6" }} />
                </div>
